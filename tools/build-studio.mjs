#!/usr/bin/env node
/* gpx-core.mjs 를 gpx-studio.html 안에 인라인으로 심어, 파일을 더블클릭만 해도 동작하게 만듭니다.
 * gpx-core.mjs 를 고친 뒤에는 반드시 `node tools/build-studio.mjs` 를 실행하세요. */
...
const clean = readFileSync(join(DIR, 'gpx-core.mjs'), 'utf8')
...
const block = `${START} — tools/gpx-core.mjs 에서 자동 생성됩니다 ===== */\n${clean}\n${END}`;
